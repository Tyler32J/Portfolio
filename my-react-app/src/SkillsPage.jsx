...
const skills = [
  ...
  { imgSrc: '/skills/postman.svg', label: 'Postman', desc: 'API Testing Tool', link: "https://www.postman.com/" },
  { imgSrc: '/skills/azure.svg', label: 'Azure', desc: 'Microsoft’s Cloud Platform ', link: "https://azure.microsoft.com" },
  { imgSrc: '/skills/azure_devops_icon.svg', label: 'Azure DevOps', desc: 'CI/CD & Project Management', link: "https://azure.microsoft.com/products/devops/" },
  { imgSrc: '/skills/intune_icon.png', label: 'Intune', desc: 'Device & App Management', link: "https://learn.microsoft.com/en-us/mem/intune/fundamentals/what-is-intune" },
  { imgSrc: '/skills/active-directory.svg', label: 'Active Directory', desc: 'Microsoft’s Cloud Platform ', link: "https://activedirectorypro.com/what-is-active-directory/" },
  { imgSrc: '/skills/sharepoint.svg', label: 'Sharepoint', desc: 'Company Sites & File Sharing', link: "https://www.microsoft.com/en-us/microsoft-365/sharepoint/collaboration" },
  { imgSrc: '/skills/excel_icon.svg', label: 'Excel', desc: 'Spreadsheets & Data Analysis', link: "https://www.microsoft.com/en-us/microsoft-365/excel" },
  { imgSrc: '/skills/word_icon.svg', label: 'Word', desc: 'Document Creation', link: "https://www.microsoft.com/en-us/microsoft-365/word" },
  { imgSrc: '/skills/powerpoint_icon.svg', label: 'PowerPoint', desc: 'Presentations & Slides', link: " https://www.microsoft.com/en-us/microsoft-365/powerpoint" },
  { imgSrc: '/skills/onedrive_icon.svg', label: 'OneDrive', desc: 'Cloud Storage', link: "https://www.microsoft.com/en-us/microsoft-365/onedrive/online-cloud-storage" },
  { imgSrc: '/skills/outlook_icon.svg', label: 'Outlook', desc: 'Email & Calendar', link: "https://outlook.live.com/" },
  { imgSrc: '/skills/teams_icon.svg', label: 'Teams', desc: 'Chat & Meetings', link: "https://www.microsoft.com/en-us/microsoft-teams/group-chat-software" },
  { imgSrc: '/skills/zoom_icon.svg', label: 'Zoom', desc: 'Video Meetings & Collaboration', link: " https://zoom.us/" },
  { imgSrc: '/skills/google_meet_icon.svg', label: 'Google Meet', desc: 'Video Meetings', link: "https://meet.google.com/" },
  { imgSrc: '/skills/google_drive_icon.svg', label: 'Google Drive', desc: 'Cloud Storage', link: "https://drive.google.com/" },
  { imgSrc: '/skills/google_docs_icon.svg', label: 'Google docs', desc: 'Online Document Editing', link: "https://docs.google.com/document/" },
  { imgSrc: '/skills/company_portal_icon.png', label: 'Company Portal', desc: 'Device & App Management', link: " https://learn.microsoft.com/en-us/mem/intune/apps/company-portal-app" },
